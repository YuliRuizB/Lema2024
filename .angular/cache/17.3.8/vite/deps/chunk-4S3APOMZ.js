import {
  ...
  ɵfirebaseAppFactory,
  ɵlazySDKProxy
} from "./chunk-4V5UEDM6.js";
import {
  firebase
} from "./chunk-VUKUMDN4.js";
import {
  isPlatformServer
...
var AngularFireAuth = class _AngularFireAuth {
  ...
  constructor(options, name, platformId, zone, schedulers, useEmulator, settings, tenantId, languageCode, useDeviceLanguage, persistence, _appCheckInstances) {
    ...
    const auth = of(void 0).pipe(observeOn(schedulers.outsideAngular), switchMap(() => zone.runOutsideAngular(() => import("./index.esm-J2O63DUR.js"))), map(() => ɵfirebaseAppFactory(options, zone, name)), map((app) => ɵauthFactory(app, zone, useEmulator, tenantId, languageCode, useDeviceLanguage, settings, persistence)), shareReplay({
      bufferSize: 1,
      refCount: false
    }));
...
//# sourceMappingURL=chunk-4S3APOMZ.js.map
